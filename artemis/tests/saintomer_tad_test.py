...
class SaintOmer(object):
    ...
    def test_saint_omer_admin_to_poi(self):
        ...
        """
        self.journey(_from="admin:fr:62595",
    ...
    def test_saint_omer_poi_to_admin(self):
        ...
        self.journey(_from="poi:adm117",
                     to="admin:fr:62595", datetime="20121206T153500",
                     walking_speed="1", max_duration_to_pt="1000")
    ...
    def test_saint_omer_admin_to_admin_01(self):
        ...
        ID artemis v1: 7
        """
        self.journey(_from="admin:fr:62765",
                     to="admin:fr:62458", datetime="20121120T101500",
                     walking_speed="1", max_duration_to_pt="1000")
    ...
    def test_saint_omer_admin_to_admin_02(self):
        ...
        ID artemis v1: 8
        """
        self.journey(_from="admin:fr:62458",
                     to="admin:fr:62765", datetime="20121120T101500",
                     walking_speed="1", max_duration_to_pt="1000")
