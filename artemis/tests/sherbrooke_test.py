...
class TestSherbrooke(ArtemisTestFixture):
    ...
    @xfail(reason="http://jira.canaltp.fr/browse/NAVITIAII-1562", raises=AssertionError)
    ...
    @xfail(reason="http://jira.canaltp.fr/browse/NAVITIAII-1568", raises=AssertionError)
